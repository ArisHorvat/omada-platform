        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleConfig = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.RoleId, x.WidgetKey });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "RoomAllowedEventTypes",
                columns: table => new
                {
                    AllowedEventTypesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SupportedRoomsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomAllowedEventTypes", x => new { x.AllowedEventTypesId, x.SupportedRoomsId });
                    table.ForeignKey(
                        name: "FK_RoomAllowedEventTypes_EventTypes_AllowedEventTypesId",
                        column: x => x.AllowedEventTypesId,
                        principalTable: "EventTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomAllowedEventTypes_Rooms_SupportedRoomsId",
                        column: x => x.SupportedRoomsId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventOverrides", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventOverrides_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventAssociations_EventId_EntityId_EntityType",
                table: "EventAssociations",
                columns: new[] { "EventId", "EntityId", "EntityType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventOverrides_EventId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomAllowedEventTypes_SupportedRoomsId",
                table: "RoomAllowedEventTypes",
                column: "SupportedRoomsId");
